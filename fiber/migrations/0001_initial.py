    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(related_name='translations', editable=False, to='fiber.ContentItem', null=True)),
            ],
            options={
                'abstract': False,
                'db_table': 'fiber_contentitemtranslation',
            },
            bases=(models.Model,),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language_code', models.CharField(max_length=15, db_index=True)),
                ('master', models.ForeignKey(related_name='translations', editable=False, to='fiber.Page', null=True)),
            ],
            options={
                'abstract': False,
                'db_table': 'fiber_pagetranslation',
            },
            bases=(models.Model,),
        ),
